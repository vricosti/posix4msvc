	...
	unsigned int flagsAndAttributes)
{
	...
	_NtCreateFile NtCreateFile = (_NtCreateFile)GetProcAddress(GetModuleHandle("ntdll.dll"), "NtCreateFile");
	_RtlInitUnicodeString RtlInitUnicodeString = (_RtlInitUnicodeString)GetProcAddress(GetModuleHandle("ntdll.dll"), "RtlInitUnicodeString");
